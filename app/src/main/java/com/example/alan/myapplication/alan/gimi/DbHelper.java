...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table videoplayhistory(_id integer primary key autoincrement ,title,image,category,duration,year,playsource,sourceicon,video_id)");
        // TODO: 2018/1/31  
    }
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        if (oldVersion != newVersion) {
            ...
            db.execSQL("drop table IF EXISTS " + "musichository");
            db.execSQL("drop table IF EXISTS " + "videoplayhistory");
